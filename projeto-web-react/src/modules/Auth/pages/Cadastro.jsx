                        ...
                        <div className="form-row">
                            <div className="form-col">
                                ...
                                <input 
                                    ...
                                    type="email" className="form-control-cadastro" placeholder="exemplo@email.com" required
                                />
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-col">
                                ...
                                <div className="password-input-container">
                                    <input 
                                        ...
                                        type={showSenha ? "text" : "password"} className="form-control-cadastro" placeholder="Mínimo 6 caracteres" required
                                    />
                            ...
                            <div className="form-col">
                                ...
                                <div className="password-input-container">
                                    <input 
                                        ...
                                        type={showSenha ? "text" : "password"} className="form-control-cadastro" required
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="form-row">
                            <div className="form-col">
                                ...
                                <input 
                                    ...
                                    type="text" className="form-control-cadastro" placeholder="Ex: João Silva" required
                                />
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-col">
                                ...
                                <input 
                                    ...
                                    type="text" className="form-control-cadastro" placeholder="000.000.000-00" required
                                />
                            </div>
                            <div className="form-col">
                                ...
                                <input 
                                    ...
                                    type="text" className="form-control-cadastro" placeholder="(00) 00000-0000" 
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="form-row">
                            <div className="form-col col-small">
                                ...
                                <input 
                                    ...
                                    type="text" className="form-control-cadastro" placeholder="00000-000" 
                                />
                            </div>
                            <div className="form-col col-medium">
                                ...
                                <input 
                                    ...
                                    type="text" className="form-control-cadastro" 
                                />
                            </div>
                            <div className="form-col col-medium">
